...
class Pocket:
    ...
    def get_auth_url(self, request_token, redirect_uri='http://example.com'):
        auth_url = ('https://getpocket.com/auth/authorize'
                    '?request_token=%s&redirect_uri=%s' % (request_token, redirect_uri))
        return auth_url
    ...
    def get_access_token(self, consumer_key, request_token):
        ...
        print response.headers['X-Error']
        return None
